...
def etl():
    ...
    from_jobskill = extract_joblink_from_jobskill_to_db()
    from_jobposting = extract_joblink_from_jobposting_to_db()
    from_jobsummary = extract_joblink_from_jobsummary_to_db()
    insert_joblink_to_db(from_jobskill)
    insert_joblink_to_db(from_jobposting)
    insert_joblink_to_db(from_jobsummary)
